...
//This is the student, starting version of the Lab07MATH01 assignment.
...
class Geometry
{
 // 2D Perimeters
	...
	public static double pallelogramArea (double b, double h)
	{
		return b * h;
	}
	...
	public static double HexogonArea (double base1, double base2, double h)
	{
 ...
 // 3D Surface Areas
	...
	public static double rectangleprismSurfaceArea (double s,double w,double h)                      
	{ 
